 ...
 *
 * ```js
 * import { firebase } from 'fcm-notifications';
 *
...
export namespace Notifications {
  ...
  export interface AndroidNotification {
     ...
     *
     * ```js
     * import notification, { AndroidColor } from 'fcm-notifications';
     *
     ...
     *
     * ```js
     * import notification from 'fcm-notifications';
     *
     * await notification.displayNotification({
     *   android: {
     ...
     *
     * ```js
     * import notification, { AndroidGroupAlertBehavior } from 'fcm-notifications';
     *
     * await notification.displayNotification({
     *   android: {
     *     group: message.group.id,
  ...
  export interface Schedule {
     ...
     *
     * ```js
     * import notifications, { AndroidRepeatInterval } from 'fcm-notifications';
     *
     * await firebase.notifications().scheduleNotification(notification, {
     *   fireDate: Date.now() + 600000,
  ...
  export class Module extends FirebaseModule {
    ...
    */
     ...
     *
     * ```js
     * firebase.notification().setBackgroundMessageHandler(async (remoteMessage) => {
...
declare module 'fcm-notifications' {
